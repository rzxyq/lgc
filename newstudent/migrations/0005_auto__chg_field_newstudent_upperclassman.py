...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewStudent.upperclassman'
        db.alter_column(u'newstudent_newstudent', 'upperclassman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['upperclassman.Upperclassman'], null=True))

    def backwards(self, orm):

        # Changing field 'NewStudent.upperclassman'
        db.alter_column(u'newstudent_newstudent', 'upperclassman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newstudent.NewStudent'], null=True))
