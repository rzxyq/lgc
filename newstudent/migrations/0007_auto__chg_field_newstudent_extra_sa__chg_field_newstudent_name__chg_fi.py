...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'newstudent_newstudent', 'extra_sa', self.gf('django.db.models.fields.TextField')(max_length=75, null=True))

        # Changing field 'NewStudent.name'
        db.alter_column(u'newstudent_newstudent', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'NewStudent.netid'
        db.alter_column(u'newstudent_newstudent', 'netid', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'NewStudent.hometown'
        db.alter_column(u'newstudent_newstudent', 'hometown', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'NewStudent.career_sa'
        db.alter_column(u'newstudent_newstudent', 'career_sa', self.gf('django.db.models.fields.TextField')(max_length=75, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NewStudent.name'
        db.alter_column(u'newstudent_newstudent', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'NewStudent.netid'
        db.alter_column(u'newstudent_newstudent', 'netid', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'NewStudent.hometown'
        db.alter_column(u'newstudent_newstudent', 'hometown', self.gf('django.db.models.fields.CharField')(max_length=50))
