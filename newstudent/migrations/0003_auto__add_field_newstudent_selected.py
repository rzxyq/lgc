...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewStudent.selected'
        db.add_column(u'newstudent_newstudent', 'selected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewStudent.selected'
        db.delete_column(u'newstudent_newstudent', 'selected')
