...
class NewStudentForm(forms.Form):
    ...
    sa1 = forms.CharField(label=("What do you hope to gain from your time at Cornell? (125 words max)"),
        widget=forms.Textarea, max_length=250)
    sa2 = forms.CharField(label=("What guidance do you want from your upperclassman? (125 words max)"),
        widget=forms.Textarea, max_length=250)
