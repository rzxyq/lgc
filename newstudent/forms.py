...
class NewStudentForm(forms.Form):
	...
	career_sa = forms.CharField(label=("Feel free to list any other specific prospective careers"),
		widget=forms.Textarea, max_length=75, required=False)

	sa1 = forms.CharField(label=("What do you hope to gain from your time at Cornell?"),
		widget=forms.Textarea, max_length=250)
	sa2 = forms.CharField(label=("What guidance do you want from your upperclassman?"),
		widget=forms.Textarea, max_length=250)
	sa3 = forms.CharField(label=("Tell us something interesting about yourself"),
		widget=forms.Textarea, max_length=250)
