...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Upperclassman.survey'
        db.add_column(u'upperclassman_upperclassman', 'survey',
                      self.gf('django.db.models.fields.TextField')(default='hi'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Upperclassman.survey'
        db.delete_column(u'upperclassman_upperclassman', 'survey')
